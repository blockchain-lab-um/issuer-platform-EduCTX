...
find /app/apps/dashboard/.next \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i "s#NEXT_PUBLIC_BACKEND_API_URL_PLACEHOLDER#$NEXT_PUBLIC_BACKEND_API_URL#g"
